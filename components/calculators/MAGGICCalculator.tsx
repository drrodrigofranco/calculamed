...
interface MAGGICCalculatorProps {
  onNavigate: (view: AppView) => void;
}

const MAGGICCalculator: React.FC<MAGGICCalculatorProps> = ({ onNavigate }) => {
  return (
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">MAGGIC Score</h1>
              <p className="text-sm text-gray-600">Insuficiência Cardíaca</p>
            </div>
          </div>
