...
const PSICalculator: React.FC<PSICalculatorProps> = ({ onNavigate }) => {
  return (
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">PSI/PORT</h1>
              <p className="text-sm text-gray-600">Pneumonia Severity</p>
            </div>
          </div>
