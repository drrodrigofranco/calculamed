  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <p className="mt-4 text-slate-500">A inteligência artificial está curando as notícias...</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto">
        <div className="mb-8 flex items-center gap-3">
            ...
            <div>
                <h2 className="text-2xl font-bold text-slate-800">Atualizações Médicas</h2>
                <p className="text-slate-500 text-sm">Resumos gerados por IA baseados em tópicos recentes</p>
            </div>
        </div>

      <div className="grid gap-6 md:grid-cols-2">
        {news.map((item, index) => (
          <div key={index} className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 hover:shadow-md transition duration-200 flex flex-col h-full">
            ...
            <div className="mt-auto pt-4 border-t border-slate-100">
              <p className="text-xs font-semibold text-slate-500 mb-1">Impacto Clínico:</p>
