...
export const PrivacyPolicy: React.FC = () => (
  <div className="bg-white dark:bg-slate-800 p-8 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 prose prose-slate dark:prose-invert max-w-none">
    <h2 className="text-2xl font-bold mb-4">Política de Privacidade</h2>
    <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">Última atualização: {new Date().toLocaleDateString()}</p>
...
export const TermsOfUse: React.FC = () => (
  <div className="bg-white dark:bg-slate-800 p-8 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 prose prose-slate dark:prose-invert max-w-none">
    ...
    <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 dark:border-red-600 p-4 mb-6">
      <h3 className="font-bold text-red-700 dark:text-red-400">Aviso Importante de Saúde</h3>
...
export const AboutUs: React.FC = () => (
    <div className="bg-white dark:bg-slate-800 p-8 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 prose prose-slate dark:prose-invert max-w-none">
      ...
      <p className="mt-6 text-sm text-slate-500 dark:text-slate-400">Contato: contato@ajudasaude.com (Exemplo)</p>
    </div>
  );