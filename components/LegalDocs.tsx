  ...
  <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-200 prose prose-slate max-w-none">
    ...
    <div className="bg-red-50 border-l-4 border-red-500 p-4 mb-6">
      ...
      <p className="text-sm text-red-800">
        O Calculamed é uma ferramenta destinada exclusivamente a <strong>profissionais de saúde</strong>. As informações fornecidas aqui não substituem o julgamento clínico profissional.
      </p>
    </div>
    ...
    <p>O design, logotipo e código fonte do Calculamed são propriedade exclusiva. O uso não autorizado é proibido.</p>
  </div>
);

export const AboutUs: React.FC = () => (
    <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-200 prose prose-slate max-w-none">
      <h2 className="text-2xl font-bold mb-4">Sobre o Calculamed</h2>
      <p>O Calculamed é uma plataforma desenvolvida para agilizar a rotina de médicos, enfermeiros e estudantes de medicina. Nossa missão é reunir as principais fórmulas e escores clínicos em um único lugar, com interface limpa, rápida e confiável.</p>
      ...
      <p className="mt-6 text-sm text-slate-500">Contato: contato@calculamed.com (Exemplo)</p>
    </div>
  );